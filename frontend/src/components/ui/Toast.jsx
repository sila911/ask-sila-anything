      ...
      <AnimatePresence mode="wait">
        {toast && (
          <motion.div
            ...
            className={`pointer-events-auto relative w-full rounded-2xl sm:rounded-3xl pl-3.5 pr-9 py-3 sm:pl-4 sm:pr-10 sm:py-3.5 border backdrop-blur-2xl ${theme.bg} ${theme.border}`}
          >
